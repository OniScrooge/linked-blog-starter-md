...
- `trigger` : The text that triggers this snippet.
    - Triggers can also be regular expressions. [See here for more info.](app://obsidian.md/DOCS.md#regex-snippets)
- `replacement` : The text to replace the `trigger` with.
    - Replacements can also be JavaScript functions. [See here for more info.](app://obsidian.md/DOCS.md#function-snippets)
- `options` : See below.
...
- `r` : [Regex](app://obsidian.md/DOCS.md#regex-snippets). The `trigger` will be treated as a regular expression
- `v` : [Visual](app://obsidian.md/DOCS.md#visual-snippets). Only run this snippet on a selection. The trigger should be a single character
...
For more details on writing snippets, including **regex** snippets and **function** snippets, [see the **documentation** here](app://obsidian.md/DOCS.md). You can [view snippets written by others and share your own snippets here](https://github.com/artisticat1/obsidian-latex-suite/discussions/50).
